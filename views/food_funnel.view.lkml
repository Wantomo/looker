view: food_funnel {
  ...
  dimension_group: lead_page_visited {
    ...
    sql: ${TABLE}.lead_page_visited ;;
    convert_tz: no
  }

  dimension_group: create_karte_step_2_page_visited {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.create_karte_step_2_page_visited ;;
    convert_tz: no
  }
  ...
  measure: count_create_karte_step_2_page_visited {
    type: number
    sql: COUNT(${create_karte_step_2_page_visited_date}) ;;
  }

  measure: count_lead_page_visited {
    type: number
    sql: COUNT(${lead_page_visited_date}) ;;
  }
